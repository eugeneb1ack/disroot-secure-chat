...
The client, relay, protocol and test scenarios are open for inspection. MLS encrypts messages in the browser; the relay routes ciphertext under a shared expiry. The [protocol documentation](docs/secure-chat.md#operating-conditions) describes the classical cryptographic suite, client trust model, network metadata and data lifecycle.
